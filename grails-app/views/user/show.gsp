	...
	<body>
		...
		<div id="show-user" class="content scaffold-show" role="main">
			...
			<ol class="property-list user">
				...
				<g:if test="${userInstance?.pwdHash}">
				<li class="fieldcontain">
					<span id="pwdHash-label" class="property-label"><g:message code="user.pwdHash.label" default="Pwd Hash" /></span>
					
						<span class="property-value" aria-labelledby="pwdHash-label"><g:fieldValue bean="${userInstance}" field="pwdHash"/></span>
